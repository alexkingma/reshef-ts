...
export const spellUsageMap: CardReducerMap<DirectSpell, CardCondition> = {
  ...
  [Spell.BrainControl]: (state, { ownMonsters, otherMonsters }) =>
    hasEmptyZone(state, ownMonsters) && hasMatchInRow(state, otherMonsters),
